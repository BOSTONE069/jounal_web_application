"""
Django settings for rjikm_app project.
...
SECRET_KEY = 'django-insecure-=^d3ny_#^b_t2egtycj_yogp5z=lkj@b=6b&l#^w=u8mh)88(='
...
WSGI_APPLICATION = 'rjikm_app.wsgi.application'
