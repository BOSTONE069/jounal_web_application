...
urlpatterns = [
    ...
    path("vol6no2_articles/", views.vol6no2_articles, name="vol6no2_articles"),
    path("vol6no1_articles/", views.vol6no1_articles, name="vol6no1_articles"),
    path("vol5no2_articles/", views.vol5no2_articles, name="vol5no2_articles"),
